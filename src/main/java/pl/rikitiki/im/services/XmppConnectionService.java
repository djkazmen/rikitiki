...
import pl.rikitiki.im.entities.MucOptions;
import pl.rikitiki.im.entities.MucOptions.OnRenameListener;
import pl.rikitiki.im.entities.Presence;
import pl.rikitiki.im.entities.PresenceTemplate;
import pl.rikitiki.im.entities.Roster;
import pl.rikitiki.im.entities.ServiceDiscoveryResult;
import pl.rikitiki.im.entities.Transferable;
import pl.rikitiki.im.entities.TransferablePlaceholder;
import pl.rikitiki.im.generator.AbstractGenerator;
import pl.rikitiki.im.generator.IqGenerator;
import pl.rikitiki.im.generator.MessageGenerator;
import pl.rikitiki.im.generator.PresenceGenerator;
import pl.rikitiki.im.http.HttpConnectionManager;
import pl.rikitiki.im.http.AesGcmURLStreamHandlerFactory;
import pl.rikitiki.im.parser.AbstractParser;
import pl.rikitiki.im.parser.IqParser;
import pl.rikitiki.im.parser.MessageParser;
import pl.rikitiki.im.parser.PresenceParser;
...
import pl.rikitiki.im.ui.UiCallback;
import pl.rikitiki.im.ui.UiInformableCallback;
import pl.rikitiki.im.utils.ConversationsFileObserver;
import pl.rikitiki.im.utils.CryptoHelper;
import pl.rikitiki.im.utils.ExceptionHelper;
import pl.rikitiki.im.utils.MimeUtils;
import pl.rikitiki.im.utils.OnPhoneContactsLoadedListener;
import pl.rikitiki.im.utils.PRNGFixes;
import pl.rikitiki.im.utils.PhoneHelper;
import pl.rikitiki.im.utils.ReplacingSerialSingleThreadExecutor;
import pl.rikitiki.im.utils.Resolver;
import pl.rikitiki.im.utils.SerialSingleThreadExecutor;
import pl.rikitiki.im.xml.Namespace;
import pl.rikitiki.im.utils.XmppUri;
import pl.rikitiki.im.xml.Element;
import pl.rikitiki.im.xmpp.OnBindListener;
import pl.rikitiki.im.xmpp.OnContactStatusChanged;
import pl.rikitiki.im.xmpp.OnIqPacketReceived;
import pl.rikitiki.im.xmpp.OnKeyStatusUpdated;
import pl.rikitiki.im.xmpp.OnMessageAcknowledged;
import pl.rikitiki.im.xmpp.OnMessagePacketReceived;
import pl.rikitiki.im.xmpp.OnPresencePacketReceived;
import pl.rikitiki.im.xmpp.OnStatusChanged;
import pl.rikitiki.im.xmpp.OnUpdateBlocklist;
import pl.rikitiki.im.xmpp.Patches;
import pl.rikitiki.im.xmpp.XmppConnection;
import pl.rikitiki.im.xmpp.chatstate.ChatState;
...
import pl.rikitiki.im.xmpp.mam.MamReference;
import pl.rikitiki.im.xmpp.pep.Avatar;
...
public class XmppConnectionService extends Service {
	...
	private final AtomicBoolean contactObserverRegistered = new AtomicBoolean(false);
	...
	public void onCreate() {
		...
		registerPhoneContactsObserverIfPermitted();
	...
	private void registerPhoneContactsObserverIfPermitted() {
		if (contactObserverRegistered.get()) {
			return;
		}
		...
		contactObserverRegistered.set(true);
	}
