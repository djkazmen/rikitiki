...
import pl.rikitiki.im.services.ExportLogsService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("pl.rikitiki.im.location.request").resolveActivity(getPackageManager()) == null;
