...
import pl.rikitiki.im.entities.ListItem;
import pl.rikitiki.im.entities.Presence;
import pl.rikitiki.im.services.XmppConnectionService.OnRosterUpdate;
import pl.rikitiki.im.ui.adapter.KnownHostsAdapter;
import pl.rikitiki.im.ui.adapter.ListItemAdapter;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_create_contact) {
            ...
            return true;
        } else if (id == R.id.action_create_conference) {
    ...
    public static class MyListFragment extends ListFragment {
        ...
        public boolean onContextItemSelected(final MenuItem item) {
            ...
            final int id = item.getItemId();
            if (id == R.id.context_start_conversation) {
                activity.openConversationForContact();
            } else if (id == R.id.context_contact_details) {
                activity.openDetailsForContact();
            } else if (id == R.id.context_contact_block_unblock) {
                activity.toggleContactBlock();
            } else if (id == R.id.context_delete_contact) {
                activity.deleteContact();
            } else if (id == R.id.context_join_conference) {
                activity.openConversationForBookmark();
            } else if (id == R.id.context_share_uri) {
                activity.shareBookmarkUri();
            } else if (id == R.id.context_delete_conference) {
