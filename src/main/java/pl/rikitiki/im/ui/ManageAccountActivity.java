...
import pl.rikitiki.im.ui.adapter.AccountAdapter;
...
public class ManageAccountActivity extends XmppActivity implements OnAccountUpdate, KeyChainAliasCallback, XmppConnectionService.OnAccountCreated {
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		if (id == R.id.mgmt_account_publish_avatar) {
			publishAvatar(selectedAccount);
			return true;
		} else if (id == R.id.mgmt_account_disable) {
			disableAccount(selectedAccount);
			return true;
		} else if (id == R.id.mgmt_account_enable) {
			enableAccount(selectedAccount);
			return true;
		} else if (id == R.id.mgmt_account_delete) {
			deleteAccount(selectedAccount);
			return true;
		} else if (id == R.id.mgmt_account_announce_pgp) {
			publishOpenPGPPublicKey(selectedAccount);
			return true;
		} else if (id == R.id.mgmt_account_change_presence) {
